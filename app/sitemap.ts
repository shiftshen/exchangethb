...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const localeRoutes = locales.flatMap((locale) => ([
    ...
    { url: `${siteUrl}/${locale}/legal/methodology`, priority: 0.5, changeFrequency: 'monthly' as const, lastModified: now, alternates: { languages: localeAlternates('/legal/methodology') } },
    { url: `${siteUrl}/${locale}/legal/disclaimer`, priority: 0.5, changeFrequency: 'monthly' as const, lastModified: now, alternates: { languages: localeAlternates('/legal/disclaimer') } },
