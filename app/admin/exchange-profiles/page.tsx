    ...
    <main className="container-shell space-y-8 py-10">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-semibold tracking-tight">Exchange profiles</h1>
          <p className="mt-2 max-w-3xl text-stone-600">Manage recommendation status, editorial tags, and risk notes for exchange detail pages.</p>
        </div>
