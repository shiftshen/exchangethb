...
export const cashProviders: CashProvider[] = [
  ...
  { slug: 'sia', name: 'SIA Money Exchange', summary: { th: 'ร้านแลกเงินย่านประตูน้ำในกรุงเทพที่เผยแพร่หน้าอัตรา เวลาเปิดทำการ และข้อมูลสำนักงานใหญ่บนเว็บทางการ', en: 'Bangkok Pratunam money changer with public rate references, branch details, and official website information for THB cash exchange decisions.', zh: '位于曼谷水门一带，官网公开展示汇率参考、门店信息与总部资料的换汇商。' }, officialUrl: 'http://www.siamoneyexchange.com', affiliate: { status: 'official_only', officialUrl: 'http://www.siamoneyexchange.com', disclosure: { th: 'โปรดตรวจสอบเรทล่าสุดจากผู้ให้บริการ', en: 'Please verify final rates with the provider.', zh: '请以门店最终汇率为准。' } } },
