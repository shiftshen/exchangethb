export function Logo() {
  return (
    <div className="flex items-center gap-3 font-semibold text-white">
      <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-500 text-surface-950 shadow-glow">
      ...
      <div>
        ...
        <div className="text-xs font-medium uppercase tracking-[0.24em] text-brand-400">Thai Baht Finder</div>
      </div>
    </div>
  );
}
